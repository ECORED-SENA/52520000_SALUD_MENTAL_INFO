export const global = {
  nombrePrograma: 'Actividad física para la salud mental.',
  codigo: '52520000',
  horas: 48,
  semanas: 4,
  modalidad: 'virtual',
  requisitosIngrso: ['Acceso a internet y a un equipo de cómputo.'],
  //imagenBannerPrincipal: require('@/assets/curso/banner-princiapal.svg'),
  videoBannerPrincipal:
    '<iframe data-v-1f9e4816="" width="560" height="315" src="https://www.youtube.com/embed/_o083_018uU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen"></iframe>',
...
export const creditos = {
  ...
  contenidoInstruccional: [
    ...
    {
      nombre: 'Mireya Rodríguez Perdomo',
      cargo: 'Experta temática',
      centro: 'Centro de formación en actividad física y cultura',
